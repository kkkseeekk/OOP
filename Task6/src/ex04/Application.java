...
public class Application {
     ...
     */
    public void run() {
    menu.add(new ViewConsoleCommand((View) view));
    menu.add(new GenerateConsoleCommand((View) view));
    menu.add(new SaveConsoleCommand((View) view));
    menu.add(new RestoreConsoleCommand((View) view));
